...
type AuthAuthentication = {
  ...
  readonly requestType: typeof proto_auth_pb.Identity;
...
type AuthAuthorization = {
  ...
  readonly responseType: typeof proto_auth_pb.FullIdentity;
};
...
export class AuthClient {
  ...
  authentication(
    requestMessage: proto_auth_pb.Identity,
  ...
  authorization(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: proto_auth_pb.FullIdentity|null) => void
  ): UnaryResponse;
  authorization(
    requestMessage: proto_auth_pb.Credential,
    callback: (error: ServiceError|null, responseMessage: proto_auth_pb.FullIdentity|null) => void
