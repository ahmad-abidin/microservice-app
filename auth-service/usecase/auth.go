...
func (u *usecase) Authentication(basicAuth string) (*string, error) {
	...
	if identity == nil {
		...
		if err != nil {
			return nil, model.WELI("e", "usecase-Aen_GIBUP", err)
		}
	...
	if err != nil {
		return nil, model.WELI("e", "usecase-Aen_E", err)
	}
...
func (u *usecase) Authorization(encryptedIdentity string) (*model.Identity, error) {
	...
	if err != nil {
		return nil, model.WELI("e", "usecase-Aor_D", err)
	}
